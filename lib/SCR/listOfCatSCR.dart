...
class ListOFDpScr extends StatefulWidget {
  int id;
String name;

  ListOFDpScr({this.id, this.name});

  @override
  _ListOFDpScrState createState() => _ListOFDpScrState();
}

class _ListOFDpScrState extends State<ListOFDpScr> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar:AppBar(centerTitle: true,title: Text(widget.name),) ,
      body: SingleChildScrollView(
        child: Column(
          children: [
            StreamBuilder<Get_all_products_json>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    print(snapshot.data.result.allProducts);
                    print(widget.id);
                    return Column(
                      children: [
                        Container(
